          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-2 justify-center w-full">
            <div className="relative w-full sm:w-auto">
              <button
                ...
                className="flex items-center justify-center w-full sm:w-auto min-w-[200px] min-h-[56px] font-roboto font-bold bg-brand-green text-brand-navy px-8 py-4 rounded-xl hover:bg-brand-navy hover:text-white transition-all duration-300 hover:shadow-[0_4px_20px_rgba(3,48,87,0.25)] text-center text-base disabled:opacity-70 disabled:cursor-not-allowed"
              >
                {isNavigating ? (
