  ...
  return (
    <section id="services" className="py-24 bg-brand-white relative overflow-hidden">
      ...
      <div className="max-w-[100vw] mx-auto relative z-10 overflow-hidden">
        ...
        {/* Section Heading */}
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4 px-6 lg:px-8">
          <h2 className="font-shareTech text-4xl sm:text-5xl font-extrabold tracking-tight text-brand-navy uppercase">
            Our Services
          </h2>
          <div className="h-1 w-20 bg-brand-green mx-auto rounded-full" />
          <p className="font-roboto font-light text-brand-navy/80 text-lg leading-relaxed pt-2">
