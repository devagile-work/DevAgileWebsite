...
export default function ServicesSection() {
  return (
    <section id="services" className="w-full flex flex-col justify-center bg-[#F4F7FA] relative overflow-hidden py-10 sm:py-16">
      {/* Grid Pattern overlay */}
      <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(3,48,87,0.02)_1px,transparent_1px),linear-gradient(to_bottom,rgba(3,48,87,0.02)_1px,transparent_1px)] bg-[size:30px_30px] z-0" />
      ...
      <div className="max-w-[100vw] mx-auto relative z-10 overflow-hidden">
        ...
        {/* Section Heading */}
        <div className="text-center max-w-3xl mx-auto mb-6 lg:mb-8 space-y-2 px-10 md:px-16 lg:px-24">
